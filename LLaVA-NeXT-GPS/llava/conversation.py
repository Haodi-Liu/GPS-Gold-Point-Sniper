...
conv_llava_llama_3 = Conversation(
    ...
    tokenizer=AutoTokenizer.from_pretrained("/raid/hdliu_raid/llava_next_model/Meta-Llama-3-8B-Instruct"),
    #tokenizer = AutoTokenizer.from_pretrained("/raid/hdliu/llava_next_model/Meta-Llama-3-8B-Instruct", use_auth_token="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"),
