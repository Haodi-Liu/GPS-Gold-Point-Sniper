...
checkpoint = "/raid/hdliu_raid/llava_next_model/checkpoints/llama3-llava-next-8b-14k-5epoch"
#checkpoint = "/raid/hdliu_raid/llava_next_model/checkpoints/llava-onevision-qwen2-7b-ov-14k-10epoch"
...
#test_root = "/raid/hdliu/datasets/cap_vid/test_heldout_18-1_frames"
...
#with open("/home/hdliu/LLaVA-NeXT/{}-decom-perf-heldin.json".format(checkpoint.rsplit('/')[-1]), "w") as f:
with open("./{}-decom-perf-somesome.json".format(checkpoint.rsplit('/')[-1]), "w") as f:
    json.dump(store, f)