...
if 'capvid' in args.dataset:
    ...
    with open("/home/hdliu/MiniGPT-4/minigptv2-direct-some.json", "w") as f:
        json.dump(store, f)
...
if 'cap_full' in args.dataset:
    ...
    with open("/home/hdliu/MiniGPT-4/minigptv2-full-perf-heldin.json", "w") as f:
        json.dump(store, f)
...
if 'cap_decom' in args.dataset:
    ...
    with open("/home/hdliu/MiniGPT-4/minigptv2-14k-50e-decom-some.json", "w") as f:
        json.dump(store, f)
