...
from minigpt4.datasets.datasets.llava_dataset import LlavaDetailDataset, LlavaReasonDataset, LlavaConversationDataset, CapVideoDataset
...
@registry.register_builder("capvid_frame")
class CapVideoBuilder(BaseDatasetBuilder):
    train_dataset_cls = CapVideoDataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/llava/capvid_frame.yaml",
    }
