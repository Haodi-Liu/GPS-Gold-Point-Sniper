...
#model = AutoPeftModelForCausalLM.from_pretrained(checkpoint, trust_remote_code=True, device_map="cuda:0").eval()
...
with open("./{}-full-perf-heldin.json".format(checkpoint.rsplit('/')[-1]), "w") as f:
    json.dump(store, f)